    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $products = [
            ...
            [
                ...
                'image' => '/images/skins/usp_kill_confirmed.jpg',
            ],
            [
                'name' => 'Karambit | Fade',
                'price' => 2500.00,
                ...
                'image' => '/images/skins/karambit_fade.jpg',
            ],
            [
                ...
                'image' => '/images/skins/gloves_vice.jpg',
            ],
            [
                ...
                'image' => '/images/skins/sticker_headshot.jpg',
            ],
            [
                ...
                'status' => $available,
                'category_ref' => CategoryFixtures::CATEGORY_REFS[0],
                'image' => '/images/skins/awp_dragon_lore.jpg',
            ],
            [
                'name' => 'M4A4 | Howl',
                'price' => 15000.00,
                ...
                'status' => $available,
                'category_ref' => CategoryFixtures::CATEGORY_REFS[0],
                'image' => '/images/skins/m4a4_howl.jpg',
            ],
            [
                ...
                'status' => $available,
                'category_ref' => CategoryFixtures::CATEGORY_REFS[1],
                'image' => '/images/skins/deagle_blaze.jpg',
            ],
            [
                'name' => 'P90 | Asiimov',
                'price' => 90.00,
                ...
                'status' => $preorder ?? $available,
                'category_ref' => CategoryFixtures::CATEGORY_REFS[0],
                'image' => '/images/skins/p90_asiimov.jpg',
            ],
            [
                ...
                'status' => $available,
                'category_ref' => CategoryFixtures::CATEGORY_REFS[1],
                'image' => '/images/skins/tec9_fuel_injector.jpg',
            ],
            [
                'name' => 'Agent | Corentin',
                'price' => 100000.00,
                ...
                'description' => 'Le goat.',
                'status' => $available,
                'category_ref' => CategoryFixtures::CATEGORY_REFS[5],
                'image' => '/images/skins/corentin.jpg',
            ],
            [
                'name' => 'Butterfly Knife | Doppler',
                'price' => 15000.00,
                'stock' => 5,
                'description' => 'Couteau papillon Doppler avec finition emeraude.',
                'status' => $available,
                'category_ref' => CategoryFixtures::CATEGORY_REFS[2],
                'image' => '/images/skins/knife_butterfly_emerald.jpg',
            ],
        ];
